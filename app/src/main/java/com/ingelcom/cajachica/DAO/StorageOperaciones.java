...
public class StorageOperaciones {
    ...
    public void subirFoto(Uri imageUri, String carpeta, Timestamp fechaHora, final StorageCallbacks.StorageCallback callback) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("Imagenes/" + carpeta + fechaHoraString); //Creamos una instancia de Firebase Storage donde indicamos el nombre de la carpeta "Imagenes/", la subcarpeta que se recibe en la variable "carpeta", y el nombre de la imagen a subir el cual será la fecha y hora seleccionada por el usuario y que se encuentra guardada en "fechaHoraString"
